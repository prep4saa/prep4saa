...
function App() {
 ...
 fontSize: "12px",
 fontWeight: "bold",
 accentColor: "rgba(255,153,0,0.2)"
 }}
 >
 <option value="en" style={{ background: "rgba(255,153,0,0.2)", color: "#D1D5DB" }}>English</option>
 <option value="ko" style={{ background: "rgba(255,153,0,0.2)", color: "#D1D5DB" }}>한국어</option>
 <option value="ja" style={{ background: "rgba(255,153,0,0.2)", color: "#D1D5DB" }}>日本語</option>
 </select>
 </div>
 {/* 운영자만 볼 수 있는 접속자수 */}
 {isAdmin && (
 <div className="visitor-count">
 <div style={{ fontSize: "10px", color: "#D1D5DB", marginBottom: "2px" }}>{t("currentVisitors")}</div>
 ...
 fontSize: "10px", color: "#D1D5DB", marginLeft: "16px", padding: "0 12px",
 borderLeft: "1px solid #2A344A",
 position: "relative"
 }}>
 {userEmail ? (
 <>
 ...
 style={{
 fontSize: "12px", color: "#D1D5DB", textAlign: "center", fontWeight: "bold",
 background: "none", border: "none", cursor: "pointer", padding: "4px 8px",
 borderRadius: "4px", transition: "all 0.2s",
 backgroundColor: showAccountMenu ? "rgba(255,153,0,0.15)" : "transparent"
 }}
 onMouseEnter={(e) => {
 if (!showAccountMenu) {
 (e.currentTarget as HTMLElement).style.backgroundColor = "rgba(255,153,0,0.1)";
 }
 }}
 onMouseLeave={(e) => {
 if (!showAccountMenu) {
 ...
 cursor: "pointer",
 textAlign: "left",
 borderBottom: "1px solid #2A344A"
 }}
 onMouseEnter={(e) => {
 (e.currentTarget as HTMLElement).style.backgroundColor = "rgba(255,153,0,0.15)";
 }}
 onMouseLeave={(e) => {
 (e.currentTarget as HTMLElement).style.backgroundColor = "transparent";
 }}
