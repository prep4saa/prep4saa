...
export const ja: Strings = {
  ...
  subscriptionUntilTemplate: "{date}まで利用可能・あと{days}日",
  cancelSuccessUntil: "購読がキャンセルされました。\n{date}まで利用いただけます。（あと{days}日）",
  cancelSuccessGeneric: "購読がキャンセルされました。現在の請求期間が終わるまではご利用いただけます。",
  cancelFailed: "購読のキャンセルに失敗しました。",
  userStatusGuest: "ゲスト",
  ...
  // Cognito ログインモーダル
  cognitoLoginTitle: "🔐 ログイン",
  cognitoForgotTitle: "🔑 パスワードリセット",
  cognitoNewPasswordTitle: "✉️ 新しいパスワード設定",
  cognitoLoginDesc: "メールアドレスとパスワードでログインしてください",
  cognitoForgotRequestDesc: "メールで再設定コードを受け取ってください",
  cognitoForgotConfirmDesc: "{email} に送信されたコードを入力してください",
  cognitoLoginPwPlaceholder: "パスワード",
  cognitoLoggingIn: "ログイン中...",
  cognitoForgotPasswordLink: "パスワードをお忘れですか？",
  cognitoErrEmailPwRequired: "メールアドレスとパスワードを入力してください。",
  cognitoErrEmailRequired: "メールアドレスを入力してください。",
  cognitoErrCodeAndPwRequired: "コードと新しいパスワードを入力してください。",
  cognitoErrPwTooShort: "パスワードは12文字以上である必要があります。",
  cognitoInfoResetCodeSent: "📧 パスワード再設定コードを {email} に送信しました。",
  cognitoCodePlaceholder: "6桁の認証コード",
  cognitoNewPwPlaceholder: "新しいパスワード（12文字以上、大文字/小文字/数字/記号）",
  cognitoChanging: "変更中...",
  cognitoChangePwAndLogin: "パスワード変更とログイン",
  cognitoSending: "送信中...",
  cognitoGetResetCode: "再設定コードを取得",
  cognitoBackToLogin: "← ログインに戻る",

  // Cognito サインアップモーダル
  cognitoSignupTitle: "🔐 サインアップ",
  cognitoEmailVerifyTitle: "✉️ メール認証",
  cognitoSignupDesc: "メールアドレスとパスワードでサインアップ (AWS Cognito)",
  cognitoEmailVerifyDesc: "{email} に送信された6桁のコードを入力してください",
  cognitoErrAllFieldsRequired: "メール、パスワード、パスワード確認をすべて入力してください。",
  cognitoErrPwMismatch: "パスワードが一致しません。もう一度確認してください。",
  cognitoErrPwTooShortSignup: "パスワードは12文字以上である必要があります（大文字/小文字、数字、記号を含む）。",
  cognitoInfoSignupCodeSent: "✅ 6桁の認証コードを {email} に送信しました。",
  cognitoErrCodeRequired: "認証コードを入力してください。",
  cognitoInfoCodeResent: "📧 コードを {email} に再送信しました。",
  cognitoSignupPwPlaceholder: "パスワード（12文字以上、大文字/小文字/数字/記号）",
  cognitoSignupPwConfirmPlaceholder: "パスワード確認",
  cognitoPwMismatchHint: "⚠️ パスワードが一致しません。",
  cognitoProcessing: "処理中...",
  cognitoConfirming: "確認中...",
