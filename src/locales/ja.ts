...
export const ja: Strings = {
  ...
  landingHonest6Desc: "弱点分野を指定すると、該当テーマの新しい問題を即座に生成します。Claude 基盤、AWS 公式ドキュメントの範囲内でのみ動作します。(Monthly プラン適用)",
  landingHonest7Title: "開発中の機能",
  landingHonest7Desc: "誤答ノート自動化、間違えた問題の再出題アルゴリズム、学習リマインダーなど、フィードバックに基づき順次追加予定です。",
