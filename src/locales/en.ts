...
export const en: Strings = {
  ...
  landingHonest6Desc: "Identify your weak areas and generate custom practice questions on demand. Powered by Claude, strictly within AWS official documentation scope. (Monthly plan)",
  landingHonest7Title: "Coming Soon",
  landingHonest7Desc: "Spaced repetition for missed questions, exam day reminders, and deeper performance analytics — prioritized based on user feedback.",
