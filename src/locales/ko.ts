export const ko = {
  ...
  landingHonestEyebrow: "지금 제공하는 것",
  landingHonestTitle: "마케팅 문구 대신, 실제로 동작하는 기능만 적었습니다.",
  landingHonestSub: "아직 완성된 제품이 아닙니다. 아래 목록은 지금 이 순간 실제로 사용 가능한 기능입니다. 앞으로 추가될 기능은 뒤에 별도로 표시했습니다.",
  ...
  landingHonest6Desc: "약점 영역을 지정하면 해당 주제의 새 문제를 즉석에서 생성합니다. Claude 기반, AWS 공식 문서 범위 내에서만 작동합니다. (Monthly 플랜 적용)",
  landingHonest7Title: "개발 중인 기능",
  landingHonest7Desc: "오답 노트 자동화, 틀린 문제 재출제 알고리즘, 카카오톡 학습 알림은 피드백을 받아 순차적으로 추가할 예정입니다.",
